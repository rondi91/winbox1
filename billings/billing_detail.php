...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    file_put_contents('../payments/payments.json', json_encode($payments, JSON_PRETTY_PRINT));
    ...
    file_put_contents('billing.json', json_encode($billings, JSON_PRETTY_PRINT)); // Save updated billing
    header('Location: billing.php'); // Redirect to the billing management page
    exit;
}
...
<body>
    <div class="container mt-4">
        <h1 class="display-6 text-center">Billing Details</h1>
...
// die();
        ...
        <form action="billing_detail.php?billing_id=<?php echo htmlspecialchars($billingId); ?>" method="POST">
            <div class="mb-3">
